...
def test_role01_historical_and_current_architecture_allowances_are_preserved() -> None:
    ...
    assert (contraction.delta.top_level_systems,contraction.delta.subsystems,contraction.delta.contract_declarations,contraction.delta.authorities,contraction.delta.import_edges)==(-1,-6,12,-7,39)
