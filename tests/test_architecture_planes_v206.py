...
class ArchitecturePlaneTests(unittest.TestCase):
    def test_composition_module_is_explicit_architecture_plane(self):
        self.assertTrue(is_composition_module("noetrium_platform.foundation.kernel.composition.experiment_runtime"))
    ...
    def test_composition_edges_do_not_pollute_authoritative_system_dag(self):
        with tempfile.TemporaryDirectory() as td:
            root = Path(td)
            path = root / "noetrium_platform/foundation/kernel/composition/sample.py"
