...
class StudyLifecycleV108Tests(unittest.TestCase):
    def test_partial_open_failure_closes_already_open_method_session(self):
        ...
        spec=context_action_spec(study_id="s", method_id="m", environment_id="e", model_stack_digest="a" * 64, prompt_generation="prompt", workload_digest="work", seed_digest="seed", repetitions=1)
