...
_DISPATCH_AUTHORITIES = frozenset({
    "research_platform/execution/participants/resolution.py",
    "research_platform/execution/participants/checkpoint_operations.py",
    "research_platform/execution/participants/session_lifecycle.py",
    "research_platform/experimentation/checkpoint/checkpoint_capture.py",
    "research_platform/experimentation/checkpoint/checkpoint_restore.py",
    "research_platform/execution/workflow/runtime/effect_intents.py",
    "research_platform/execution/workflow/implementations/context_action/action_slot_guard.py",
    "research_platform/execution/workflow/implementations/context_action/action_capability.py",
    "research_platform/execution/workflow/implementations/context_action/action_authorization.py",
    "research_platform/execution/workflow/implementations/context_action/context_action_operations.py",
    "research_platform/execution/workflow/implementations/context_action/action_effect_provider.py",
    "research_platform/execution/workflow/implementations/context_action/action_reconciliation_operations.py",
    "research_platform/execution/workflow/implementations/context_action/method_completion.py",
    "research_platform/execution/workflow/implementations/context_action/action_recovery_binding.py",
    "research_platform/execution/workflow/implementations/agent_turn/capability_effect_provider.py",
    "research_platform/execution/workflow/implementations/agent_turn/agent_turn_operations.py",
    "research_platform/execution/workflow/implementations/agent_turn/capability_operations.py",
})
...
def _audit_dispatch_authority(root: Path) -> list[SourceInvariantViolation]:
    ...
    scan_roots = (
        root / "research_platform" / "experimentation" / "experiment",
        root / "research_platform" / "execution" / "workflow" / "runtime",
        root / "research_platform" / "execution" / "workflow" / "implementations" / "context_action",
        root / "research_platform" / "execution" / "workflow" / "implementations" / "agent_turn",
    )
...
def _audit_workflow_dependency_direction(root: Path) -> list[SourceInvariantViolation]:
    ...
    forbidden = (
        ...
        "research_platform.execution.workflow.runtime",
...
def audit_workflow_invariants(root: Path) -> list[SourceInvariantViolation]:
    ...
    runtime_root = root / "research_platform" / "execution" / "workflow" / "runtime"
    ...
    effect_ops = root / "research_platform" / "execution" / "workflow" / "runtime" / "effect_intents.py"
