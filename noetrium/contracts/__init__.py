...
__all__ = [
    ...
    "StudyMatrixExecutor", "AggregationFunction", "AggregationSpec", "CsvTableReader",
    "DataColumn", "DataTable", "FigureCell", "FigureKind", "FigurePoint",
    ...
    "PairedComparison", "ResearchReport", "ScientificStatistics", "SplitStrategy",
