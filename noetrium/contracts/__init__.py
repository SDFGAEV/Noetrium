...
__all__ = [
    ...
    "StudyMatrixExecutor", "AggregationFunction", "AggregationSpec", "BaselineRegistryPort",
    "BaselineSpec", "CsvTableReader", "DataColumn", "DataTable", "EvaluationContext",
    "EvaluationStage", "FigureCell", "FigureKind", "FigurePoint",
    ...
    "PairedComparison", "ResearchEvaluation", "ResearchLifecycle", "ResearchReport",
    "ScientificStatistics", "SplitStrategy",
    "StandardTableRenderer", "StudyObservationTableAdapter", "SvgFigureRenderer", "TablePipeline",
