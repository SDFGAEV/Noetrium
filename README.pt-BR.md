...
O metadata da distribuição Python se chama `noetrium`; o import namespace atual continua `research_platform` enquanto product identity e runtime contracts evoluem de forma independente.
