...
El metadata de la distribución Python se llama `noetrium`; el import namespace actual sigue siendo `research_platform` mientras product identity y runtime contracts evolucionan de forma independiente.
